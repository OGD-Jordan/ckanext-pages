...
def default_news_schema():
    return {
        ...
        'brief_ar': [not_empty, unicode_safe, get_validator('validate_arabic_text'), validators.max_length_validator(100), validators.min_length_validator(40)],
        'brief_en': [not_empty, unicode_safe, get_validator('validate_english_text'), validators.max_length_validator(100), validators.min_length_validator(40)],
        'content_en': [not_empty, unicode_safe],
        'content_ar': [not_empty, unicode_safe],
...
def link_required_if_link_type_or_menu_child(key, data, errors, context):
    ...
    if menu_type == 'link':
        ...
        tk.get_validator('url_validator')(key, data, errors, context)
